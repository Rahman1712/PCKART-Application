...
*/
  ...
  /*============== products=======================================*/
	public getProductsByParentCategoryName(parentName: string):Observable<ProductDTO<any>[]> {
    return this.http.get<ProductDTO<any>[]>(`${this.apiProductUrl}/get/all/bycategory/parent/byname/${parentName}`);
	}
  ...
  public getProductsByParentCategoryNameAndFilter(
    parentName: string,filterOptions: any):Observable<ProductDTO<any>[]> 
  {
    return this.http.get<ProductDTO<any>[]>(`${this.apiProductUrl}/get/all/bycategory/filter/parent/byname/${parentName}`, { params: filterOptions });
	}
  public getProductsByCategoryNameAndFilter(
    categoryName: string,filterOptions: any):Observable<ProductDTO<any>[]> 
  {
    return this.http.get<ProductDTO<any>[]>(`${this.apiProductUrl}/get/all/bycategory/filter/byname/${categoryName}`, { params: filterOptions });
	}

	public getProductsByCategoryName(categoryName: string):Observable<ProductDTO<any>[]> {
    return this.http.get<ProductDTO<any>[]>(`${this.apiProductUrl}/get/all/bycategory/byname/${categoryName}`);
	}

  public getProductByIdWithImages(productId: number): Observable<ProductDTO<any>>{
    return this.http.get<ProductDTO<any>>(`${this.apiProductUrl}/get/product-imgs/${productId}`);
  }

  public getProductDetailsMainImageById(productId: number): Observable<ProductDTO<any>>{
    return this.http.get<ProductDTO<any>>(`${this.apiProductUrl}/get/product/${productId}`);
  }
  ...
  public getAllProductsByKeywordAndLimit(searchKeyword: string, limit: number):Observable<ProductDTO<any>[]>{
    const params = {
      searchKeyword: searchKeyword,
      limit: limit,
    }
    return this.http.get<ProductDTO<any>[]>(`${this.apiProductUrl}/get/all/bySearch_and_Limit`, {params: params});
  }
  
  /* ========================== PRODUCT PAGINATION GET =============================== */
  ///get/page-imgs/1?sortField=name&sortDir=asc&limit=5.....
  public getProductsWithImagesAndPagination(pageNum:number,limit:number,sortField:string, sortDir:string, searchKeyword:string): Observable<ProductPagination<ProductDTO<any>>>{
    const params = new HttpParams()
      .set('limit',limit).set('sortField',sortField)
      .set('sortDir',sortDir).set('searchKeyword',searchKeyword);
    
      return this.http.get<ProductPagination<ProductDTO<any>>>(`${this.apiProductUrl}/get/page-imgs/${pageNum}`,{params});
  }
}
